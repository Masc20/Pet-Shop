        ...
        <div class="col-md-3">
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body" style="background-color: #fff8e1;">
                    <form id="filterForm" method="GET" action="<?php echo BASE_URL; ?>/pets">
                        <div class="mb-3">
                            <label class="form-label" style="color: #FF8C00;">Search</label>
                            <input type="text" id="searchInput" name="query" class="form-control" placeholder="Search pets..." style="border-color: #FFD700;" value="<?php echo htmlspecialchars($filterQuery ?? ''); ?>">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="typeFilter" name="type" class="form-select" style="border-color: #FFD700; color: #333;">
                                ...
                                <option value="dog" <?php echo (isset($filterType) && $filterType === 'dog') ? 'selected' : ''; ?>>Dogs</option>
                                <option value="cat" <?php echo (isset($filterType) && $filterType === 'cat') ? 'selected' : ''; ?>>Cats</option>
                            </select>
                        </div>
                        
                        <button type="submit" class="btn btn-primary w-100" style="background-color: #FF8C00; border-color: #FF8C00;">Apply Filters</button>
                        <?php if (!empty($filterQuery) || !empty($filterType)): ?>
